...
def create_pdf_eurocode(bolt_type, bolt_diameter, bolt_classe, tete_fraisee_check, resine_check, df_bolt_data, df_assembly_data, recouvrement_une_rangee, plan_cisaill, df_loads_data, L_cat, tp , Lj, Result_Cat_A, Result_Cat_B, Result_Cat_C, Result_Cat_D, Result_Cat_E, Result_Cat_Combine, marge_min_A, marge_min_B, marge_min_C, marge_min_D, marge_min_E, marge_min_combine):
    ...
    text_2_3_1bis = Paragraph("- F<sub>v,x,Ed</sub> la composante sur X de l'effort de cisaillement à l'état limite ultime, rapporté à l'axe de la liaison boulonnée", normal_style)
    elements.append(text_2_3_1bis)
    text_2_3_1bis = Paragraph("- F<sub>v,y,Ed</sub> la composante sur Y de l'effort de cisaillement à l'état limite ultime, rapporté à l'axe de la liaison boulonnée", normal_style)
    elements.append(text_2_3_1bis)
    text_2_3_1bis = Paragraph("- F<sub>v,x,Ed,ser</sub> la composante sur X de l'effort de cisaillement à l'état limite de service, rapporté à l'axe de la liaison boulonnée", normal_style)
    elements.append(text_2_3_1bis)
    ...
    elements.append(text_2_3_1bis)
    text_2_3_1bis = Paragraph("- F<sub>0</sub> l'effort de préserrage", normal_style)
    elements.append(text_2_3_1bis)
    ...
    if L_cat[0] : # Catégorie A - criteres 
        ...
        text = Paragraph("Catégorie A :", normal_style)
    ...
    if L_cat[1] : # Catégorie B - criteres
        ...
        text = Paragraph("Catégorie B :", normal_style)
        elements.append(text)
        if resine_check :
    ...
    if L_cat[2] : # Catégorie C - criteres
        ...
        text = Paragraph("Catégorie C :", normal_style)
        elements.append(text)
        if resine_check :
    ...
    if L_cat[3] or L_cat[4] : # Catégorie D ou E - criteres
        ...
        if L_cat[3] :
            text = Paragraph("Catégorie D :", normal_style)
        else : 
            text = Paragraph("Catégorie E :", normal_style)
        elements.append(text)
    ...
    if L_cat[5] : # Efforts combinés
        ...
        text = Paragraph("Cisaillement et traction combinés :", normal_style)
        elements.append(text)
    ...
    if L_cat[1] :
        ...
        # Résistance au cisaillement FvRd
        if tp > bolt_diameter/3 :
            image_B_general_path = "Pictures/EUROCODE_Criteres_Formules/eurocode_formules_CatB_FvRd-tp.png"
            image_width = page_width - 2.16*inch
            image_B_general = Image(image_B_general_path)
            image_B_general.drawHeight = image_width * image_B_general.drawHeight / image_B_general.drawWidth
            image_B_general.drawWidth = image_width
            if Lj > 15*bolt_diameter :
                image_B_general_path = "Pictures/EUROCODE_Criteres_Formules/eurocode_formules_CatB_FvRd-tp-Lj.png"
                image_width = page_width - 2.16*inch
                image_B_general = Image(image_B_general_path)
                image_B_general.drawHeight = image_width * image_B_general.drawHeight / image_B_general.drawWidth
                image_B_general.drawWidth = image_width
            ...
            if Lj > 15*bolt_diameter :
                image_B_general_path = "Pictures/EUROCODE_Criteres_Formules/eurocode_formules_CatB_FvRd-Lj.png"
                image_width = page_width - 2.16*inch
                image_B_general = Image(image_B_general_path)
                image_B_general.drawHeight = image_width * image_B_general.drawHeight / image_B_general.drawWidth
                image_B_general.drawWidth = image_width
            else :
                image_B_general_path = "Pictures/EUROCODE_Criteres_Formules/eurocode_formules_CatB_FvRd-general.png"
                image_width = page_width - 2.16*inch
                image_B_general = Image(image_B_general_path)
                image_B_general.drawHeight = image_width * image_B_general.drawHeight / image_B_general.drawWidth
                image_B_general.drawWidth = image_width
        ...
        # Résistance à la pression diamétrale FbRd
        image_B_general_path = "Pictures/EUROCODE_Criteres_Formules/eurocode_formules_CatB_FbRd-general.png"
        image_width = page_width - 2.16*inch
        image_B_general = Image(image_B_general_path)
        image_B_general.drawHeight = image_width * image_B_general.drawHeight / image_B_general.drawWidth
        image_B_general.drawWidth = image_width
        ...
        elements.append(Spacer(1, 10))
        if recouvrement_une_rangee :
            image_B_general_path = "Pictures/EUROCODE_Criteres_Formules/eurocode_formules_CatB_FbRd-supplement simple recouvrement.png"
            image_width = page_width - 2.16*inch
            image_B_general = Image(image_B_general_path)
            image_B_general.drawHeight = image_width * image_B_general.drawHeight / image_B_general.drawWidth
            image_B_general.drawWidth = image_width
        ...
        if resine_check :
            ...
            image_B_general.drawWidth = image_width
            if L_cat[5] :
                image_B_general_path = "Pictures/EUROCODE_Criteres_Formules/eurocode_formules_CatB_FsRdser-injecte-combines.png"
                image_width = page_width - 2.16*inch
                image_B_general = Image(image_B_general_path)
                image_B_general.drawHeight = image_width * image_B_general.drawHeight / image_B_general.drawWidth
                image_B_general.drawWidth = image_width
            ...
            if L_cat[5] :
                image_B_general_path = "Pictures/EUROCODE_Criteres_Formules/eurocode_formules_CatB_FsRdser-combines.png"
                image_width = page_width - 2.16*inch
                image_B_general = Image(image_B_general_path)
                image_B_general.drawHeight = image_width * image_B_general.drawHeight / image_B_general.drawWidth
                image_B_general.drawWidth = image_width
            else :
                image_B_general_path = "Pictures/EUROCODE_Criteres_Formules/eurocode_formules_CatB_FsRdser-general.png"
                image_width = page_width - 2.16*inch
                image_B_general = Image(image_B_general_path)
                image_B_general.drawHeight = image_width * image_B_general.drawHeight / image_B_general.drawWidth
                image_B_general.drawWidth = image_width
    ...
    if L_cat[2] :
        ...
        if resine_check :
            ...
            image_C_general.drawWidth = image_width
            if L_cat[5] :
                image_C_general_path = "Pictures/EUROCODE_Criteres_Formules/eurocode_formules_CatC_FsRd-injecte-combines.png"
                image_width = page_width - 2.16*inch
                image_C_general = Image(image_C_general_path)
                image_C_general.drawHeight = image_width * image_C_general.drawHeight / image_C_general.drawWidth
                image_C_general.drawWidth = image_width
            ...
            if L_cat[5] :
                image_C_general_path = "Pictures/EUROCODE_Criteres_Formules/eurocode_formules_CatC_FsRd-combines.png"
                image_width = page_width - 2.16*inch
                image_C_general = Image(image_C_general_path)
                image_C_general.drawHeight = image_width * image_C_general.drawHeight / image_C_general.drawWidth
                image_C_general.drawWidth = image_width
            else :
                image_C_general_path = "Pictures/EUROCODE_Criteres_Formules/eurocode_formules_CatC_FsRd-general.png"
                image_width = page_width - 2.16*inch
                image_C_general = Image(image_C_general_path)
                image_C_general.drawHeight = image_width * image_C_general.drawHeight / image_C_general.drawWidth
                image_C_general.drawWidth = image_width
    ...
    if L_cat[3] or L_cat[4] :
        ...
        image_DE_general_path = "Pictures/EUROCODE_Criteres_Formules/eurocode_formules_CatDE.png"
        image_width = page_width - 2.16*inch
        image_DE_general = Image(image_DE_general_path)
        image_DE_general.drawHeight = image_width * image_DE_general.drawHeight / image_DE_general.drawWidth
        image_DE_general.drawWidth = image_width
