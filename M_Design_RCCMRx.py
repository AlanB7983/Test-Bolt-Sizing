...
def page_RCCMRx() :
    ...
    # Variables
    liste_material = ["304L SS", "316L SS", "660 SS", "Acier Classe 6-8", "Alloy 718", "316L", "A4L-80", "A4L-70", "A2L-80", "A2L-70", "F15NM trempe-revenu (X4CrNiMo16-05-01)", "Acier 10.9"]
    ...
    with st.expander("INTRODUCTION ET RAPPEL DES HYPOTHÈSES.") :
        ...
        st.write("Les résultats sont ensuite générés sous la forme :")
